...
filaree <- read.csv("..//Desktop//xmpl_filaree.csv", header=TRUE) # Make sure you have the correct path
names(filaree)
filaree <- whatever
...
nm1 <- lm(lnwt ~ day*t + day*I(t^2), data=filaree)
summary(nm1)
drop1(nm1)

nm2 <- lm(lnwt ~ day*t+I(t^2)+I(day^2) , data=filaree)
summary(nm2)
